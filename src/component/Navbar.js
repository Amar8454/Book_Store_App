...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 right-0 left-0 z-50 dark:bg-slate-900 dark:text-white ${
          sticky
      ...
      >
        <div className="navbar">
          ...
          <div className="navbar-end space-x-2">
            ...
            <div className=" ">
              <a
                className=" bg-black px-2 py-1 text-white rounded-md cursor-pointer"
                onClick={() =>
